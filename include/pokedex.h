...
#define NATIONAL_DIVERGENT_DEX_TAILLOW 408 // 18
#define NATIONAL_DIVERGENT_DEX_SWELLOW 409 // 19
#define NATIONAL_DIVERGENT_DEX_AZURILL 410 // 20
#define NATIONAL_DIVERGENT_DEX_MARILL 411 // 21
#define NATIONAL_DIVERGENT_DEX_AZUMARILL 412 // 22
#define NATIONAL_DIVERGENT_DEX_CLEFFA 413 // 23
#define NATIONAL_DIVERGENT_DEX_CLEFAIRY 414 // 24
#define NATIONAL_DIVERGENT_DEX_CLEFABLE 415 // 25
#define NATIONAL_DIVERGENT_DEX_CHEWTLE 416 // 26
#define NATIONAL_DIVERGENT_DEX_DREDNAW 417 // 27
#define NATIONAL_DIVERGENT_DEX_BOUNSWEET 418 // 28
#define NATIONAL_DIVERGENT_DEX_STEENEE 419 // 29
#define NATIONAL_DIVERGENT_DEX_TSAREENA 420 // 30
#define NATIONAL_DIVERGENT_DEX_WOOBAT 421 // 31
#define NATIONAL_DIVERGENT_DEX_SWOOBAT 422 // 32
#define NATIONAL_DIVERGENT_DEX_DIGLETT 423 // 33
#define NATIONAL_DIVERGENT_DEX_DUGTRIO 424 // 34
#define NATIONAL_DIVERGENT_DEX_DEWPIDER 425 // 35
#define NATIONAL_DIVERGENT_DEX_ARAQUANID 426 // 36
#define NATIONAL_DIVERGENT_DEX_FOMANTIS 427 // 37
#define NATIONAL_DIVERGENT_DEX_LURANTIS 428 // 38
#define NATIONAL_DIVERGENT_DEX_SENTRET 429 // 39
#define NATIONAL_DIVERGENT_DEX_FURRET 430 // 40
#define NATIONAL_DIVERGENT_DEX_POLIWAG 431 // 41
#define NATIONAL_DIVERGENT_DEX_POLIWHIRL 432 // 42
#define NATIONAL_DIVERGENT_DEX_POLIWRATH 433 // 43
#define NATIONAL_DIVERGENT_DEX_POLITOED 434 // 44
#define NATIONAL_DIVERGENT_DEX_HOPPIP 435 // 45
#define NATIONAL_DIVERGENT_DEX_SKIPLOOM 436 // 46
#define NATIONAL_DIVERGENT_DEX_JUMPLUFF 437 // 47
#define NATIONAL_DIVERGENT_DEX_SEWADDLE 438 // 48
#define NATIONAL_DIVERGENT_DEX_SWADLOON 439 // 49
#define NATIONAL_DIVERGENT_DEX_LEAVANNY 440 // 50
#define NATIONAL_DIVERGENT_DEX_WEEDLE 441 // 51
#define NATIONAL_DIVERGENT_DEX_KAKUNA 442 // 52
#define NATIONAL_DIVERGENT_DEX_BEEDRILL 443 // 53
#define NATIONAL_DIVERGENT_DEX_CATERPIE 444 // 54
#define NATIONAL_DIVERGENT_DEX_METAPOD 445 // 55
#define NATIONAL_DIVERGENT_DEX_BUTTERFREE 446 // 56
#define NATIONAL_DIVERGENT_DEX_PANSAGE 447 // 57
#define NATIONAL_DIVERGENT_DEX_SIMISAGE 448 // 58
#define NATIONAL_DIVERGENT_DEX_BUNNELBY 449 // 59
#define NATIONAL_DIVERGENT_DEX_DIGGERSBY 450 // 60
#define NATIONAL_DIVERGENT_DEX_DRIFLOON 451 // 61
#define NATIONAL_DIVERGENT_DEX_DRIFBLIM 452 // 62
#define NATIONAL_DIVERGENT_DEX_MEDITITE 453 // 63
#define NATIONAL_DIVERGENT_DEX_MEDICHAM 454 // 64
#define NATIONAL_DIVERGENT_DEX_MAKUHITA 455 // 65
#define NATIONAL_DIVERGENT_DEX_HARIYAMA 456 // 66
#define NATIONAL_DIVERGENT_DEX_PIDGEY 457 // 67
#define NATIONAL_DIVERGENT_DEX_PIDGEOTTO 458 // 68
#define NATIONAL_DIVERGENT_DEX_PIDGEOT 459 // 69
#define NATIONAL_DIVERGENT_DEX_BLITZLE 460 // 70
#define NATIONAL_DIVERGENT_DEX_ZEBSTRIKA 461 // 71
#define NATIONAL_DIVERGENT_DEX_DUCKLETT 462 // 72
#define NATIONAL_DIVERGENT_DEX_SWANNA 463 // 73
#define NATIONAL_DIVERGENT_DEX_MILCERY 464 // 74
#define NATIONAL_DIVERGENT_DEX_ALCREMIE 465 // 75
#define NATIONAL_DIVERGENT_DEX_SILICOBRA 466 // 76
#define NATIONAL_DIVERGENT_DEX_SANDACONDA 467 // 77
#define NATIONAL_DIVERGENT_DEX_MARACTUS 468 // 78
#define NATIONAL_DIVERGENT_DEX_DWEBBLE 469 // 79
#define NATIONAL_DIVERGENT_DEX_CRUSTLE 470 // 80
#define NATIONAL_DIVERGENT_DEX_BALTOY 471 // 81
#define NATIONAL_DIVERGENT_DEX_CLAYDOL 472 // 82
#define NATIONAL_DIVERGENT_DEX_SKORUPI 473 // 83
#define NATIONAL_DIVERGENT_DEX_DRAPION 474 // 84
#define NATIONAL_DIVERGENT_DEX_MACHOP 475 // 85
#define NATIONAL_DIVERGENT_DEX_MACHOKE 476 // 86
#define NATIONAL_DIVERGENT_DEX_MACHAMP 477 // 87
#define NATIONAL_DIVERGENT_DEX_ABRA 478 // 88
#define NATIONAL_DIVERGENT_DEX_KADABRA 479 // 89
#define NATIONAL_DIVERGENT_DEX_ALAKAZAM 480 // 90
#define NATIONAL_DIVERGENT_DEX_SNUBBULL 481 // 91
#define NATIONAL_DIVERGENT_DEX_GRANBULL 482 // 92
#define NATIONAL_DIVERGENT_DEX_MEOWTH 483 // 93
#define NATIONAL_DIVERGENT_DEX_PERRSERKER 484 // 94
#define NATIONAL_DIVERGENT_DEX_SOLOSIS 485 // 95
#define NATIONAL_DIVERGENT_DEX_DUOSION 486 // 96
#define NATIONAL_DIVERGENT_DEX_REUNICLUS 487 // 97
#define NATIONAL_DIVERGENT_DEX_NATU 488 // 98
#define NATIONAL_DIVERGENT_DEX_XATU 489 // 99
#define NATIONAL_DIVERGENT_DEX_TYNAMO 490 // 100
#define NATIONAL_DIVERGENT_DEX_EELEKTRIK 491 // 101
#define NATIONAL_DIVERGENT_DEX_EELEKTROSS 492 // 102
#define NATIONAL_DIVERGENT_DEX_LARVITAR 493 // 103
#define NATIONAL_DIVERGENT_DEX_PUPITAR 494 // 104
#define NATIONAL_DIVERGENT_DEX_TYRANITAR 495 // 105
#define NATIONAL_DIVERGENT_DEX_MAGNEMITE 496 // 106
#define NATIONAL_DIVERGENT_DEX_MAGNETON 497 // 107
#define NATIONAL_DIVERGENT_DEX_MAGNEZONE 498 // 108
#define NATIONAL_DIVERGENT_DEX_ARON 499 // 109
#define NATIONAL_DIVERGENT_DEX_LAIRON 500 // 110
#define NATIONAL_DIVERGENT_DEX_AGGRON 501 // 111
#define NATIONAL_DIVERGENT_DEX_VANILLITE 502 // 112
#define NATIONAL_DIVERGENT_DEX_VANILLISH 503 // 113
#define NATIONAL_DIVERGENT_DEX_VANILLUXE 504 // 114
#define NATIONAL_DIVERGENT_DEX_SPHEAL 505 // 115
#define NATIONAL_DIVERGENT_DEX_SEALEO 506 // 116
#define NATIONAL_DIVERGENT_DEX_WALREIN 507 // 117
#define NATIONAL_DIVERGENT_DEX_GEODUDE 508 // 118
#define NATIONAL_DIVERGENT_DEX_GRAVELER 509 // 119
#define NATIONAL_DIVERGENT_DEX_GOLEM 510 // 120
#define NATIONAL_DIVERGENT_DEX_SMOOCHUM 511 // 121
#define NATIONAL_DIVERGENT_DEX_JYNX 512 // 122
#define NATIONAL_DIVERGENT_DEX_SANDSHREW 513 // 123
#define NATIONAL_DIVERGENT_DEX_SANDSLASH 514 // 124
#define NATIONAL_DIVERGENT_DEX_ORICORIO 515 // 125
#define NATIONAL_DIVERGENT_DEX_NUMEL 516 // 126
#define NATIONAL_DIVERGENT_DEX_CAMERUPT 517 // 127
#define NATIONAL_DIVERGENT_DEX_BAGON 518 // 128
#define NATIONAL_DIVERGENT_DEX_SHELGON 519 // 129
#define NATIONAL_DIVERGENT_DEX_SALAMENCE 520 // 130
#define NATIONAL_DIVERGENT_DEX_FEEBAS 521 // 131
#define NATIONAL_DIVERGENT_DEX_MILOTIC 522 // 132
#define NATIONAL_DIVERGENT_DEX_DEERLING 523 // 133
#define NATIONAL_DIVERGENT_DEX_SAWSBUCK 524 // 134
#define NATIONAL_DIVERGENT_DEX_VULPIX 525 // 135
#define NATIONAL_DIVERGENT_DEX_NINETALES 526 // 136
#define NATIONAL_DIVERGENT_DEX_PANSEAR 527 // 137
#define NATIONAL_DIVERGENT_DEX_SIMISEAR 528 // 138
#define NATIONAL_DIVERGENT_DEX_CUBONE 529 // 139
#define NATIONAL_DIVERGENT_DEX_MAROWAK 530 // 140
#define NATIONAL_DIVERGENT_DEX_MAGBY 531 // 141
#define NATIONAL_DIVERGENT_DEX_MAGMAR 532 // 142
#define NATIONAL_DIVERGENT_DEX_MAGMORTAR 533 // 143
#define NATIONAL_DIVERGENT_DEX_PETILIL 534 // 144
#define NATIONAL_DIVERGENT_DEX_LILLIGANT 535 // 145
#define NATIONAL_DIVERGENT_DEX_TOGEDEMARU 536 // 146
#define NATIONAL_DIVERGENT_DEX_APPLIN 537 // 147
#define NATIONAL_DIVERGENT_DEX_FLAPPLE 538 // 148
#define NATIONAL_DIVERGENT_DEX_APPLETUN 539 // 149
#define NATIONAL_DIVERGENT_DEX_ELECTRIKE 540 // 150
#define NATIONAL_DIVERGENT_DEX_MANECTRIC 541 // 151
#define NATIONAL_DIVERGENT_DEX_AUDINO 542 // 152
#define NATIONAL_DIVERGENT_DEX_STUFFUL 543 // 153
#define NATIONAL_DIVERGENT_DEX_BEWEAR 544 // 154
#define NATIONAL_DIVERGENT_DEX_TYROGUE 545 // 155
#define NATIONAL_DIVERGENT_DEX_HITMONLEE 546 // 156
#define NATIONAL_DIVERGENT_DEX_HITMONCHAN 547 // 157
#define NATIONAL_DIVERGENT_DEX_HITMONTOP 548 // 158
#define NATIONAL_DIVERGENT_DEX_TYMPOLE 549 // 159
#define NATIONAL_DIVERGENT_DEX_PALPITOAD 550 // 160
#define NATIONAL_DIVERGENT_DEX_SEISMITOAD 551 // 161
#define NATIONAL_DIVERGENT_DEX_CRAMORANT 552 // 162
#define NATIONAL_DIVERGENT_DEX_ELEKID 553 // 163
#define NATIONAL_DIVERGENT_DEX_ELECTABUZZ 554 // 164
#define NATIONAL_DIVERGENT_DEX_ELECTIVIRE 555 // 165
#define NATIONAL_DIVERGENT_DEX_PANPOUR 556 // 166
#define NATIONAL_DIVERGENT_DEX_SIMIPOUR 557 // 167
#define NATIONAL_DIVERGENT_DEX_WIMPOD 558 // 168
#define NATIONAL_DIVERGENT_DEX_GOLISOPOD 559 // 169
#define NATIONAL_DIVERGENT_DEX_EXEGGCUTE 560 // 170
#define NATIONAL_DIVERGENT_DEX_EXEGGUTOR 561 // 171
#define NATIONAL_DIVERGENT_DEX_NOSEPASS 562 // 172
#define NATIONAL_DIVERGENT_DEX_PROBOPASS 563 // 173
#define NATIONAL_DIVERGENT_DEX_ANORITH 564 // 174
#define NATIONAL_DIVERGENT_DEX_ARMALDO 565 // 175
#define NATIONAL_DIVERGENT_DEX_GULPIN 566 // 176
#define NATIONAL_DIVERGENT_DEX_SWALOT 567 // 177
#define NATIONAL_DIVERGENT_DEX_DODUO 568 // 178
#define NATIONAL_DIVERGENT_DEX_DODRIO 569 // 179
#define NATIONAL_DIVERGENT_DEX_TROPIUS 570 // 180
// DITTO has no divergent dex number - reuses NATIONAL_DEX_DITTO (same number in both modes)
#define NATIONAL_DIVERGENT_DEX_STUNKY 572 // 182
#define NATIONAL_DIVERGENT_DEX_SKUNTANK 573 // 183
#define NATIONAL_DIVERGENT_DEX_PANCHAM 574 // 184
#define NATIONAL_DIVERGENT_DEX_PANGORO 575 // 185
#define NATIONAL_DIVERGENT_DEX_SINISTEA 576 // 186
#define NATIONAL_DIVERGENT_DEX_POLTEAGEIST 577 // 187
#define NATIONAL_DIVERGENT_DEX_KLEFKI 578 // 188
#define NATIONAL_DIVERGENT_DEX_LITWICK 579 // 189
#define NATIONAL_DIVERGENT_DEX_LAMPENT 580 // 190
#define NATIONAL_DIVERGENT_DEX_CHANDELURE 581 // 191
#define NATIONAL_DIVERGENT_DEX_DREEPY 582 // 192
#define NATIONAL_DIVERGENT_DEX_DRAKLOAK 583 // 193
#define NATIONAL_DIVERGENT_DEX_DRAGAPULT 584 // 194
#define NATIONAL_DIVERGENT_DEX_ODDISH 585 // 195
#define NATIONAL_DIVERGENT_DEX_GLOOM 586 // 196
#define NATIONAL_DIVERGENT_DEX_VILEPLUME 587 // 197
#define NATIONAL_DIVERGENT_DEX_BELLOSSOM 588 // 198
#define NATIONAL_DIVERGENT_DEX_GASTLY 589 // 199
#define NATIONAL_DIVERGENT_DEX_HAUNTER 590 // 200
#define NATIONAL_DIVERGENT_DEX_GENGAR 591 // 201
#define NATIONAL_DIVERGENT_DEX_TRUBBISH 592 // 202
#define NATIONAL_DIVERGENT_DEX_GARBODOR 593 // 203
#define NATIONAL_DIVERGENT_DEX_PORYGON 594 // 204
#define NATIONAL_DIVERGENT_DEX_PORYGON2 595 // 205
#define NATIONAL_DIVERGENT_DEX_PORYGON_Z 596 // 206
#define NATIONAL_DIVERGENT_DEX_AIPOM 597 // 207
#define NATIONAL_DIVERGENT_DEX_AMBIPOM 598 // 208
#define NATIONAL_DIVERGENT_DEX_MUNCHLAX 599 // 209
#define NATIONAL_DIVERGENT_DEX_SNORLAX 600 // 210
#define NATIONAL_DIVERGENT_DEX_SMEARGLE 601 // 211
// ROTOM has no divergent dex number - reuses NATIONAL_DEX_ROTOM (same number in both modes)
#define NATIONAL_DIVERGENT_DEX_TANGELA 603 // 213
#define NATIONAL_DIVERGENT_DEX_TANGROWTH 604 // 214
#define NATIONAL_DIVERGENT_DEX_PONYTA 605 // 215
#define NATIONAL_DIVERGENT_DEX_RAPIDASH 606 // 216
#define NATIONAL_DIVERGENT_DEX_SPRITZEE 607 // 217
#define NATIONAL_DIVERGENT_DEX_AROMATISSE 608 // 218
#define NATIONAL_DIVERGENT_DEX_MUNNA 609 // 219
#define NATIONAL_DIVERGENT_DEX_MUSHARNA 610 // 220
#define NATIONAL_DIVERGENT_DEX_GROWLITHE 611 // 221
#define NATIONAL_DIVERGENT_DEX_ARCANINE 612 // 222
#define NATIONAL_DIVERGENT_DEX_GOLETT 613 // 223
#define NATIONAL_DIVERGENT_DEX_GOLURK 614 // 224
#define NATIONAL_DIVERGENT_DEX_BELDUM 615 // 225
#define NATIONAL_DIVERGENT_DEX_METANG 616 // 226
#define NATIONAL_DIVERGENT_DEX_METAGROSS 617 // 227
#define NATIONAL_DIVERGENT_DEX_ONIX 618 // 228
#define NATIONAL_DIVERGENT_DEX_STEELIX 619 // 229
#define NATIONAL_DIVERGENT_DEX_DEINO 620 // 230
#define NATIONAL_DIVERGENT_DEX_ZWEILOUS 621 // 231
#define NATIONAL_DIVERGENT_DEX_HYDREIGON 622 // 232
#define NATIONAL_DIVERGENT_DEX_GLIGAR 623 // 233
#define NATIONAL_DIVERGENT_DEX_GLISCOR 624 // 234
