...
const struct PokedexEntry gPokedexEntries[DIVERGENT_DEX_COUNT] =
{
	[NATIONAL_DEX_NONE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_CATERPIE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_METAPOD] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_BUTTERFREE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_BEEDRILL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PIDGEOTTO] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PIDGEOT] =
	{
		.categoryName = {_B, _i, _r, _d, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 15,
		.weight = 395,
	...
	[NATIONAL_DIVERGENT_DEX_SANDSHREW] =
	{
		.categoryName = {_M, _o, _u, _s, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 6,
		.weight = 120,
	...
	[NATIONAL_DIVERGENT_DEX_SANDSLASH] =
	{
		.categoryName = {_M, _o, _u, _s, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 295,
	...
	[NATIONAL_DIVERGENT_DEX_CLEFAIRY] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_CLEFABLE] =
	{
		.categoryName = {_F, _a, _i, _r, _y, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 13,
		.weight = 400,
	...
	[NATIONAL_DIVERGENT_DEX_NINETALES] =
	{
		.categoryName = {_F, _o, _x, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 11,
		.weight = 199,
	...
	[NATIONAL_DIVERGENT_DEX_VILEPLUME] =
	{
	...
	// 	.trainerOffset = 1,
	// },
	[NATIONAL_DIVERGENT_DEX_DIGLETT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DUGTRIO] =
	{
		.categoryName = {_M, _o, _l, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 7,
		.weight = 333,
	...
	[NATIONAL_DIVERGENT_DEX_GROWLITHE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ARCANINE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_POLIWAG] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_POLIWHIRL] =
	{
		.categoryName = {_T, _a, _d, _p, _o, _l, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 200,
	...
	[NATIONAL_DIVERGENT_DEX_POLIWRATH] =
	{
		.categoryName = {_T, _a, _d, _p, _o, _l, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 13,
		.weight = 540,
	...
	[NATIONAL_DIVERGENT_DEX_KADABRA] =
	{
		.categoryName = {_P, _s, _i, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 13,
		.weight = 565,
	...
	[NATIONAL_DIVERGENT_DEX_ALAKAZAM] =
	{
		.categoryName = {_P, _s, _i, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 15,
		.weight = 480,
	...
	[NATIONAL_DIVERGENT_DEX_MACHOKE] =
	{
		.categoryName = {_S, _u, _p, _e, _r, _p, _o, _w, _e, _r, _END, _SPACE},
		.height = 15,
		.weight = 705,
	...
	[NATIONAL_DIVERGENT_DEX_MACHAMP] =
	{
		.categoryName = {_S, _u, _p, _e, _r, _p, _o, _w, _e, _r, _END, _SPACE},
		.height = 16,
		.weight = 1300,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_GEODUDE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_GRAVELER] =
	{
		.categoryName = {_R, _o, _c, _k, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 1050,
	...
	[NATIONAL_DIVERGENT_DEX_RAPIDASH] =
	{
		.categoryName = {_F, _i, _r, _e, _SPACE, _H, _o, _r, _s, _e, _END, _SPACE},
		.height = 17,
		.weight = 950,
	...
	[NATIONAL_DIVERGENT_DEX_MAGNEMITE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MAGNETON] =
	{
		.categoryName = {_M, _a, _g, _n, _e, _t, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 600,
	...
	[NATIONAL_DIVERGENT_DEX_DEWGONG] =
	{
		.categoryName = {_S, _e, _a, _SPACE, _L, _i, _o, _n, _END, _SPACE, _SPACE, _SPACE},
		.height = 17,
		.weight = 1200,
	...
	[NATIONAL_DIVERGENT_DEX_HAUNTER] =
	{
		.categoryName = {_G, _a, _s, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 16,
		.weight = 1,
	...
	[NATIONAL_DIVERGENT_DEX_KINGLER] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_VOLTORB] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ELECTRODE] =
	{
		.categoryName = {_B, _a, _l, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 12,
		.weight = 666,
	...
	[NATIONAL_DIVERGENT_DEX_EXEGGCUTE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_EXEGGUTOR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MAROWAK] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_HITMONLEE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_HITMONCHAN] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_RHYHORN] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_TANGELA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_STARMIE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SCYTHER] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ELECTABUZZ] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PORYGON] =
	{
	...
	// 	.trainerOffset = 65534,
	// },
	[NATIONAL_DIVERGENT_DEX_AERODACTYL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SNORLAX] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SENTRET] =
	{
	...
	// 	.trainerOffset = 65534,
	// },
	[NATIONAL_DIVERGENT_DEX_SPINARAK] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ARIADOS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_BELLOSSOM] =
	{
		.categoryName = {_F, _l, _o, _w, _e, _r, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 4,
		.weight = 58,
	...
	[NATIONAL_DIVERGENT_DEX_AZUMARILL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_POLITOED] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SKIPLOOM] =
	{
		.categoryName = {_C, _o, _t, _t, _o, _n, _w, _e, _e, _d, _END, _SPACE},
		.height = 6,
		.weight = 10,
	...
	[NATIONAL_DIVERGENT_DEX_JUMPLUFF] =
	{
		.categoryName = {_C, _o, _t, _t, _o, _n, _w, _e, _e, _d, _END, _SPACE},
		.height = 8,
		.weight = 30,
	...
	[NATIONAL_DIVERGENT_DEX_QUAGSIRE] =
	{
		.categoryName = {_W, _a, _t, _e, _r, _SPACE, _F, _i, _s, _h, _END, _SPACE},
		.height = 14,
		.weight = 750,
	...
	[NATIONAL_DIVERGENT_DEX_MURKROW] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_STEELIX] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SNUBBULL] =
	{
		.categoryName = {_F, _a, _i, _r, _y, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 6,
		.weight = 78,
	...
	[NATIONAL_DIVERGENT_DEX_GRANBULL] =
	{
		.categoryName = {_F, _a, _i, _r, _y, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 14,
		.weight = 487,
	...
	[NATIONAL_DIVERGENT_DEX_QWILFISH] =
	{
		.categoryName = {_B, _a, _l, _l, _o, _o, _n, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 5,
		.weight = 39,
	...
	[NATIONAL_DIVERGENT_DEX_DONPHAN] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PORYGON2] =
	{
		.categoryName = {_V, _i, _r, _t, _u, _a, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 6,
		.weight = 325,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_SMEARGLE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_TYROGUE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_HITMONTOP] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SMOOCHUM] =
	{
	...
	// 	.trainerOffset = 7,
	// },
	[NATIONAL_DIVERGENT_DEX_LARVITAR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PUPITAR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_TYRANITAR] =
	{
		.categoryName = {_A, _r, _m, _o, _r, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 20,
		.weight = 2020,
	...
	// 	.trainerOffset = 65534,
	// },
	[NATIONAL_DIVERGENT_DEX_ZIGZAGOON] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_LINOONE] =
	{
	...
	// 	.trainerOffset = 65534,
	// },
	// [NATIONAL_DIVERGENT_DEX_TAILLOW] =
	// {
	...
	// 	.trainerOffset = 65534,
	// },
	// [NATIONAL_DIVERGENT_DEX_SWELLOW] =
	// {
	...
	// 	.trainerOffset = 65534,
	// },
	[NATIONAL_DIVERGENT_DEX_MAKUHITA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_HARIYAMA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_AZURILL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_NOSEPASS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MEDITITE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MEDICHAM] =
	{
		.categoryName = {_M, _e, _d, _i, _t, _a, _t, _e, _END, _SPACE, _SPACE, _SPACE},
		.height = 13,
		.weight = 315,
	...
	[NATIONAL_DIVERGENT_DEX_ELECTRIKE] =
	{
		.categoryName = {_L, _i, _g, _h, _t, _n, _i, _n, _g, _END, _SPACE, _SPACE},
		.height = 6,
		.weight = 152,
	...
	[NATIONAL_DIVERGENT_DEX_MANECTRIC] =
	{
	...
	// [NATIONAL_DIVERGENT_DEX_WAILMER] =
	// {
	...
	// 	.trainerOffset = 10,
	// },
	// [NATIONAL_DIVERGENT_DEX_WAILORD] =
	// {
	...
	[NATIONAL_DIVERGENT_DEX_CAMERUPT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ALTARIA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ZANGOOSE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SEVIPER] =
	{
	...
	// 	.trainerOffset = 65534,
	// },
	[NATIONAL_DIVERGENT_DEX_BARBOACH] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_WHISCASH] =
	{
		.categoryName = {_W, _h, _i, _s, _k, _e, _r, _s, _END, _SPACE, _SPACE, _SPACE},
		.height = 9,
		.weight = 236,
	...
	[NATIONAL_DIVERGENT_DEX_CLAYDOL] =
	{
		.categoryName = {_C, _l, _a, _y, _SPACE, _D, _o, _l, _l, _END, _SPACE, _SPACE},
		.height = 15,
		.weight = 1080,
	...
	[NATIONAL_DIVERGENT_DEX_ANORITH] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ARMALDO] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MILOTIC] =
	{
	...
	// 	.trainerOffset = 65534,
	// },
	[NATIONAL_DIVERGENT_DEX_SHUPPET] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_BANETTE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_TROPIUS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_WALREIN] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SHELGON] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SALAMENCE] =
	{
		.categoryName = {_D, _r, _a, _g, _o, _n, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 15,
		.weight = 1026,
	...
	[NATIONAL_DIVERGENT_DEX_METAGROSS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_STARAVIA] =
	{
		.categoryName = {_S, _t, _a, _r, _l, _i, _n, _g, _END, _SPACE, _SPACE, _SPACE},
		.height = 6,
		.weight = 155,
	...
	[NATIONAL_DIVERGENT_DEX_STARAPTOR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_KRICKETOT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_KRICKETUNE] =
	{
		.categoryName = {_C, _r, _i, _c, _k, _e, _t, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 255,
	...
	[NATIONAL_DIVERGENT_DEX_AMBIPOM] =
	{
		.categoryName = {_L, _o, _n, _g, _SPACE, _T, _a, _i, _l, _END, _SPACE, _SPACE},
		.height = 12,
		.weight = 203,
	...
	[NATIONAL_DIVERGENT_DEX_DRIFLOON] =
	{
		.categoryName = {_B, _a, _l, _l, _o, _o, _n, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 4,
		.weight = 12,
	...
	[NATIONAL_DIVERGENT_DEX_DRIFBLIM] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_HONCHKROW] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SKUNTANK] =
	{
		.categoryName = {_S, _k, _u, _n, _k, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 380,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_SPIRITOMB] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MUNCHLAX] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SKORUPI] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DRAPION] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ABOMASNOW] =
	{
		.categoryName = {_F, _r, _o, _s, _t, _SPACE, _T, _r, _e, _e, _END, _SPACE},
		.height = 22,
		.weight = 1355,
	...
	[NATIONAL_DIVERGENT_DEX_MAGNEZONE] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_RHYPERIOR] =
	{
		.categoryName = {_D, _r, _i, _l, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 24,
		.weight = 2828,
	...
	[NATIONAL_DIVERGENT_DEX_TANGROWTH] =
	{
		.categoryName = {_V, _i, _n, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 20,
		.weight = 1286,
	...
	[NATIONAL_DIVERGENT_DEX_ELECTIVIRE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MAGMORTAR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_YANMEGA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_GLISCOR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PORYGON_Z] =
	{
		.categoryName = {_V, _i, _r, _t, _u, _a, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 9,
		.weight = 340,
	...
	[NATIONAL_DIVERGENT_DEX_PROBOPASS] =
	{
		.categoryName = {_C, _o, _m, _p, _a, _s, _s, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 14,
		.weight = 3400,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_HEATRAN] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_DARKRAI] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_PANSAGE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SIMISAGE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PANSEAR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SIMISEAR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PANPOUR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SIMIPOUR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MUSHARNA] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_BLITZLE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ZEBSTRIKA] =
	{
		.categoryName = {_T, _h, _u, _n, _d, _e, _r, _b, _o, _l, _t, _END},
		.height = 16,
		.weight = 795,
	...
	[NATIONAL_DIVERGENT_DEX_SWOOBAT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_TYMPOLE] =
	{
		.categoryName = {_T, _a, _d, _p, _o, _l, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 5,
		.weight = 45,
	...
	[NATIONAL_DIVERGENT_DEX_PALPITOAD] =
	{
		.categoryName = {_V, _i, _b, _r, _a, _t, _i, _o, _n, _END, _SPACE, _SPACE},
		.height = 8,
		.weight = 170,
	...
	[NATIONAL_DIVERGENT_DEX_SEISMITOAD] =
	{
		.categoryName = {_V, _i, _b, _r, _a, _t, _i, _o, _n, _END, _SPACE, _SPACE},
		.height = 15,
		.weight = 620,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_SEWADDLE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SWADLOON] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_LEAVANNY] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PETILIL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_LILLIGANT] =
	{
	...
	[NATIONAL_DEX_DARUMAKA] =
	{
		...
		.height = 6,
		.weight = 375,
		.description = DEX_ENTRY_DARUMAKA_G,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 256,
		.pokemonOffset = 0,
		.trainerScale = 256,
	...
	[NATIONAL_DEX_DARMANITAN] =
	{
		...
		.height = 13,
		.weight = 929,
		.description = DEX_ENTRY_DARMANITAN_G,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 256,
		.pokemonOffset = 0,
		.trainerScale = 256,
	...
	[NATIONAL_DIVERGENT_DEX_MARACTUS] =
	{
		.categoryName = {_C, _a, _c, _t, _u, _s, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 1720,
	...
	[NATIONAL_DIVERGENT_DEX_DWEBBLE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_CRUSTLE] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_TRUBBISH] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_GARBODOR] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_SOLOSIS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DUOSION] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_REUNICLUS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DUCKLETT] =
	{
		.categoryName = {_W, _a, _t, _e, _r, _SPACE, _B, _i, _r, _d, _END, _SPACE},
		.height = 5,
		.weight = 55,
	...
	[NATIONAL_DIVERGENT_DEX_VANILLITE] =
	{
		.categoryName = {_F, _r, _e, _s, _h, _SPACE, _S, _n, _o, _w, _END, _SPACE},
		.height = 4,
		.weight = 57,
	...
	[NATIONAL_DIVERGENT_DEX_VANILLISH] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_VANILLUXE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DEERLING] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SAWSBUCK] =
	{
		.categoryName = {_S, _e, _a, _s, _o, _n, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 19,
		.weight = 925,
	...
	[NATIONAL_DIVERGENT_DEX_EELEKTRIK] =
	{
		.categoryName = {_E, _l, _e, _F, _i, _s, _h, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 12,
		.weight = 220,
	...
	[NATIONAL_DIVERGENT_DEX_EELEKTROSS] =
	{
		.categoryName = {_E, _l, _e, _F, _i, _s, _h, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 21,
		.weight = 805,
	...
	[NATIONAL_DIVERGENT_DEX_LITWICK] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_LAMPENT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_CHANDELURE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_CRYOGONAL] =
	{
	...
	[NATIONAL_DEX_STUNFISK] =
	{
		...
		.height = 7,
		.weight = 110,
		.description = DEX_ENTRY_STUNFISK_G,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 256,
		.pokemonOffset = 0,
		.trainerScale = 256,
	...
	[NATIONAL_DIVERGENT_DEX_DRUDDIGON] =
	{
		.categoryName = {_C, _a, _v, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 16,
		.weight = 1390,
	...
	[NATIONAL_DIVERGENT_DEX_BOUFFALANT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_HEATMOR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ZWEILOUS] =
	{
		.categoryName = {_H, _o, _s, _t, _i, _l, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 14,
		.weight = 500,
	...
	[NATIONAL_DIVERGENT_DEX_HYDREIGON] =
	{
		.categoryName = {_B, _r, _u, _t, _a, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 18,
		.weight = 1600,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_TORNADUS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_THUNDURUS] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_LANDORUS] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	// [NATIONAL_DIVERGENT_DEX_MELOETTA] =
	// {
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_GENESECT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_BUNNELBY] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DIGGERSBY] =
	{
		.categoryName = {_D, _i, _g, _g, _i, _n, _g, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 424,
	...
	[NATIONAL_DIVERGENT_DEX_PANCHAM] =
	{
		.categoryName = {_P, _l, _a, _y, _f, _u, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 6,
		.weight = 80,
	...
	[NATIONAL_DIVERGENT_DEX_PANGORO] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_HONEDGE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DOUBLADE] =
	{
		.categoryName = {_S, _w, _o, _r, _d, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 8,
		.weight = 45,
	...
	[NATIONAL_DIVERGENT_DEX_AEGISLASH] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SPRITZEE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_AROMATISSE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DRAGALGE] =
	{
		.categoryName = {_M, _o, _c, _k, _SPACE, _K, _e, _l, _p, _END, _SPACE, _SPACE},
		.height = 18,
		.weight = 815,
	...
	[NATIONAL_DIVERGENT_DEX_HAWLUCHA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DEDENNE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_XERNEAS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ORICORIO] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_WISHIWASHI] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DEWPIDER] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ARAQUANID] =
	{
		.categoryName = {_W, _a, _t, _e, _r, _B, _u, _b, _b, _l, _e, _END},
		.height = 18,
		.weight = 820,
	...
	[NATIONAL_DIVERGENT_DEX_FOMANTIS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_LURANTIS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_STUFFUL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_BOUNSWEET] =
	{
		.categoryName = {_F, _r, _u, _i, _t, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 3,
		.weight = 32,
	...
	[NATIONAL_DIVERGENT_DEX_STEENEE] =
	{
		.categoryName = {_F, _r, _u, _i, _t, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 7,
		.weight = 82,
	...
	[NATIONAL_DIVERGENT_DEX_TSAREENA] =
	{
		.categoryName = {_F, _r, _u, _i, _t, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 12,
		.weight = 214,
	...
	[NATIONAL_DIVERGENT_DEX_GOLISOPOD] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_TOGEDEMARU] =
	{
	...
	// [NATIONAL_DIVERGENT_DEX_MAGEARNA] =
	// {
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_CHEWTLE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DREDNAW] =
	{
		.categoryName = {_B, _i, _t, _e, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 10,
		.weight = 1155,
	...
	[NATIONAL_DIVERGENT_DEX_FLAPPLE] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_APPLETUN] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SILICOBRA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_SANDACONDA] =
	{
		.categoryName = {_S, _a, _n, _d, _SPACE, _S, _n, _a, _k, _e, _END, _SPACE},
		.height = 38,
		.weight = 655,
	...
	[NATIONAL_DIVERGENT_DEX_CRAMORANT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_CLOBBOPUS] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_GRAPPLOCT] =
	{
		.categoryName = {_T, _a, _n, _t, _r, _u, _m, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 16,
		.weight = 390,
	...
	[NATIONAL_DIVERGENT_DEX_SINISTEA] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_POLTEAGEIST] =
	{
		.categoryName = {_B, _l, _a, _c, _k, _SPACE, _T, _e, _a, _END, _SPACE, _SPACE},
		.height = 2,
		.weight = 4,
	...
	[NATIONAL_DIVERGENT_DEX_IMPIDIMP] =
	{
		.categoryName = {_W, _i, _l, _y, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 4,
		.weight = 55,
	...
	[NATIONAL_DIVERGENT_DEX_MORGREM] =
	{
		.categoryName = {_D, _e, _v, _i, _o, _u, _s, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 8,
		.weight = 125,
	...
	[NATIONAL_DIVERGENT_DEX_GRIMMSNARL] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_OBSTAGOON] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_PERRSERKER] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_MILCERY] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_ALCREMIE] =
	{
		.categoryName = {_C, _r, _e, _a, _m, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 3,
		.weight = 5,
	...
	[NATIONAL_DIVERGENT_DEX_INDEEDEE] =
	{
		.categoryName = {_E, _m, _o, _t, _i, _o, _n, _END, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 9,
		.weight = 280,
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_ARCTOZOLT] =
	{
		.categoryName = {_F, _o, _s, _s, _i, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 23,
		.weight = 1500,
	...
	[NATIONAL_DIVERGENT_DEX_DRACOVISH] =
	{
		.categoryName = {_F, _o, _s, _s, _i, _l, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 23,
		.weight = 2150,
	...
	[NATIONAL_DIVERGENT_DEX_DRAKLOAK] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_DRAGAPULT] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_URSHIFU] =
	{
		.categoryName = {_W, _u, _s, _h, _u, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 19,
		.weight = 1050,
	...
	[NATIONAL_DIVERGENT_DEX_SPECTRIER] =
	{
	...
	// 	.trainerOffset = 0,
	// },
	[NATIONAL_DIVERGENT_DEX_KLEAVOR] =
	{
	...
	[NATIONAL_DIVERGENT_DEX_OVERQWIL] =
	{
