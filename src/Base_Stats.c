...
const struct BaseStats gBaseStats[] = 
{
	...
	[SPECIES_FERROSEED] =
	{
		...
		.eggGroup1 = EGG_GROUP_GRASS,
		.eggGroup2 = EGG_GROUP_MINERAL,
		.ability1 = ABILITY_ROUGHSKIN, // Translates to IRON BARBS in CFRU
		.ability2 = ABILITY_NONE,
		.safariZoneFleeRate = 0,
		.hiddenAbility = ABILITY_NONE,
		.noFlip = TRUE,
	...
	[SPECIES_GLASTRIER] = 
	{
		...
		.eggGroup1 = EGG_GROUP_UNDISCOVERED,
		.eggGroup2 = EGG_GROUP_UNDISCOVERED,
		.ability1 = ABILITY_MOXIE,	// Renamed via CFRU name override
		.ability2 = ABILITY_NONE,
		.safariZoneFleeRate = 0,
		.hiddenAbility = ABILITY_NONE,
		.noFlip = TRUE,
	...
	[SPECIES_SAMUROTT_H] =
	{
		...
		.ability2 = ABILITY_NONE,
		.safariZoneFleeRate = 0,
		.hiddenAbility = ABILITY_STRONGJAW, // Sharpness
		.noFlip = TRUE,
	},
	[SPECIES_LILLIGANT_H] =
	{
